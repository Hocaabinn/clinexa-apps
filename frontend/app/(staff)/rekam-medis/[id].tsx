        ...
        <View style={tw`flex-row gap-8`}>
          ...
          <View style={tw`flex-[2.5]`}>
            {isGranted ? (
              ...
              <View style={tw`bg-white rounded-2xl p-10 shadow-sm border border-[#e2e8f0] items-center justify-center min-h-[300px]`}>
                <Ionicons name="lock-closed" size={48} color="#ef4444" style={tw`mb-4`} />
                <Text style={tw`text-[#0b4771] text-xl font-bold mb-2`}>Akses Terkunci</Text>
                <Text style={tw`text-[#64748b] text-center max-w-md leading-relaxed`}>
                  Anda tidak memiliki izin untuk melihat detail rekam medis ini karena akses telah ditolak, dibatalkan, atau kedaluwarsa oleh pasien.
                </Text>
              </View>
            )}
          </View>
